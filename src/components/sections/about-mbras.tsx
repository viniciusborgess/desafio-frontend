  ...
  return (
    <section className="py-0 md:py-0 bg-slate-900 text-white w-full" id="about-mbras">
      <div className="flex flex-col md:flex-row w-full h-auto md:h-[400px] overflow-hidden shadow-lg">
        {/* Imagem do imóvel */}
        <div className="relative w-full md:w-1/2 h-56 xs:h-64 md:h-auto min-h-[180px]">
          <Image
        ...
        {/* Texto institucional */}
        <div className="w-full md:w-1/2 flex flex-col justify-center items-center md:items-start px-4 sm:px-8 py-6 md:py-0 bg-slate-900">
          <h2 className="text-2xl sm:text-3xl font-bold mb-4 font-sans text-center md:text-left">Sobre a MBRAS Imóveis</h2>
          <p className="text-base sm:text-lg mb-4 font-light text-center md:text-left">
          ...
          <p className="text-sm sm:text-base max-w-2xl mx-auto md:mx-0 text-center md:text-left">
